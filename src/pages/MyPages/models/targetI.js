import { targetI } from '@/services/myapi';
...
export default {
  ...
  effects: {
    *get(_, { call, put }) {
      const response = yield call(targetI.get);
      yield put({
        type: 'getSuccess',
        targetList: response,
      });
    ...
    *add({ payload }, { call, put }) {
      const response = yield call(targetI.add, { newTarget: payload });
      if (response == 'ok') {
    ...
    *del({ payload }, { call, put }) {
      const re = yield call(targetI.del, { targetId: payload });
    ...
    *update({ payload }, { call, put }) {
      const re = yield call(targetI.update, payload);
